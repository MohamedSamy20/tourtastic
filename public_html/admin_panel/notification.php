...
<?php
	...
	if (isset($_REQUEST['keyword']) && $_REQUEST['keyword']<>"") {
		...
		$sql =  "SELECT * FROM tbl_notification WHERE title LIKE '%$keyword%'";
				...
				<div class="card corner-radius">
					<div class="header">
						...
						<div class="header-dropdown m-r--5">
							<a href="notification-add.php"><button type="button" class="button button-rounded btn-offset waves-effect waves-float">ADD NOTIFICATION</button></a>
						</div>
					</div>
