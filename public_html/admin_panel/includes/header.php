...
<?php
$settingsResult = $connect->query("SELECT * FROM tbl_settings WHERE id = '1'");
$settingsRow = $settingsResult->fetch_assoc();
$username = $_SESSION["user"];
$userResult = $connect->query(
    "SELECT id, username, email FROM tbl_admin WHERE username = '$username'"
);
