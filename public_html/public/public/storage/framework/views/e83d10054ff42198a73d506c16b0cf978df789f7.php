                    ...
                    <div class="panel-body">
                        <ul class="panel-navs">
                            <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="<?php if($current_group == $k): ?> active <?php endif; ?>"><a href="<?php echo e(route('core.admin.settings.index',['group'=>$k])); ?>">
                                    <?php if($row['icon']): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/earntbpk/public_html/modules/Core/Views/admin/settings/index.blade.php ENDPATH**/ ?>