            ...
            <div class="col-md-12">
                    ...
                    <div class="col-left">
                        <form method="get" action="" class="filter-form filter-form-left d-flex justify-content-start flex-column flex-sm-row">
                            ...
                            <select name="search_by" class="form-control">
                                <option value=""><?php echo e(__("Search By")); ?></option>
                                <option <?php if(Request()->search_by == 'original_text'): ?> selected <?php endif; ?> value="original_text"><?php echo e(__("Original Text")); ?></option>
                                <option <?php if(Request()->search_by == 'translated_text'): ?> selected <?php endif; ?> value="translated_text"><?php echo e(__("Translated Text")); ?></option>
                            </select>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="<?php echo e(route('language.admin.translations.store',['id'=>$lang->id])); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="text-center">
                                <button class="btn btn-primary"><i class="fa fa-save"></i> <?php echo e(__('Save changes')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/earntbpk/public_html/modules/Language/Views/translations/detail.blade.php ENDPATH**/ ?>