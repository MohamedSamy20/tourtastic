<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="<?php echo clean($translation->title); ?>" placeholder="<?php echo e(__("Name of the car")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<?php endif; ?><?php /**PATH /home/earntbpk/public_html/modules/Car/Views/admin/car/content.blade.php ENDPATH**/ ?>