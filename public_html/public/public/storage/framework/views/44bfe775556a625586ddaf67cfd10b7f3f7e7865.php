<div class="bravo-form-search-all hero-block hero-v1 bg-img-hero-bottom gradient-overlay-half-black-gradient text-center z-index-2" style="background-image: url('<?php echo e($bg_image_url); ?>') !important;">
    <div class="container space-2 space-top-xl-4">
        <div class="row justify-content-center pb-xl-8">
            <div class="pt-15 pb-10 py-xl-10 pb-5">
        ...
        <?php if(empty($hide_form_search)): ?>
            <div class="mb-lg-n1">
                <ul class="nav tab-nav flex-nowrap tab-nav-shadow justify-content-start <?php if(!empty($single_form_search)): ?> d-none <?php endif; ?>" role="tablist">
...
<?php /**PATH /home/earntbpk/public_html/themes/Mytravel/Template/Views/frontend/blocks/form-search-all-service/style_3.blade.php ENDPATH**/ ?>