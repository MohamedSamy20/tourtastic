...
<?php if(!empty($services) and $services->total()): ?>
    <div class="bravo-profile-list-services">
        <?php echo $__env->make('Space::frontend.blocks.list-space.style_1', ['rows'=>$services,'desc'=>' ','title'=>!empty($view_all) ? __('Space by :name',['name'=>$user->first_name]) :'','col'=>4], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
<?php /**PATH /home/earntbpk/public_html/themes/Mytravel/Space/Views/frontend/profile/service.blade.php ENDPATH**/ ?>