<div class="bravo-list-item <?php if(!$rows->count()): ?> not-found <?php endif; ?>">
    ...
    <?php else: ?>
        <div class="not-found-box">
            <h3 class="n-title"><?php echo e(__("We couldn't find any boats.")); ?></h3>
            <p class="p-desc"><?php echo e(__("Try changing your filter criteria")); ?></p>
            
        </div>
    <?php endif; ?>
</div>
<?php /**PATH /home/earntbpk/public_html/themes/Mytravel/Boat/Views/frontend/layouts/search-map/list-item.blade.php ENDPATH**/ ?>