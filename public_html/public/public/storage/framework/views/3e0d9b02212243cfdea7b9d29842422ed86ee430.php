        ...
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <br>
                        <div id="sms-testing" style="cursor: pointer;" class="btn btn-primary"><?php echo e(__('Send Sms Test')); ?></div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-controls">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '#sms-testing', function (e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('sms.admin.testSms')); ?>',
                    type: 'get',
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/earntbpk/public_html/modules/Sms/Views/admin/settings/sms.blade.php ENDPATH**/ ?>