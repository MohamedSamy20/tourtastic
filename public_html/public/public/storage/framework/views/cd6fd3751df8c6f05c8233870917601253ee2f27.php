        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'<?php echo e(route('tour.vendor.availability.store')); ?>',
                        data:this.form,
                        dataType:'json',
                        method:'post',
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/earntbpk/public_html/themes/Mytravel/Tour/Views/frontend/user/availability.blade.php ENDPATH**/ ?>