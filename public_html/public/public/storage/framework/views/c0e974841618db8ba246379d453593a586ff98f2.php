...
<?php $__env->startSection('content'); ?>
    <h2 class="title-bar no-border-bottom">
        <?php echo e(__("Availability Rooms")); ?>
    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events:{
                    url:"<?php echo e(route('hotel.vendor.room.availability.loadDates',['hotel_id'=>$hotel->id])); ?>",
                    extraParams:{
                        id:lastId,
                    }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'<?php echo e(route('hotel.vendor.room.availability.store',['hotel_id'=>$hotel->id])); ?>',
                        data:this.form,
                        dataType:'json',
                        method:'post',
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/earntbpk/public_html/themes/Mytravel/Hotel/Views/frontend/user/availability.blade.php ENDPATH**/ ?>