...
<script src="<?php echo e(asset('libs/vertical-calendar/vertical-calendar.js?_ver='.config('app.asset_version'))); ?>"></script>
<script>
	new VerticalEventCalendar({
        el:'#booking-calendar',
		eventHeaderName:'<?php echo e(__('Tours')); ?>'
    });
    var baseColumnWidth = ($('.vec-header-toolbar').width() - $('.vec-event-header').width() - 5 ) / <?php echo e(date('t',$current_month)); ?>;
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/earntbpk/public_html/modules/Tour/Views/admin/booking/index.blade.php ENDPATH**/ ?>