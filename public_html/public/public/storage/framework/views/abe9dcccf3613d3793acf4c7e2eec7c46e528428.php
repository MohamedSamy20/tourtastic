                ...
                <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                    <div class="p-4">
                                ...
                                <div class="mb-4">
                                    <div class="border-bottom border-width-2 border-color-1 pb-1">
                                        <div class="flex-center-between mb-1 text-dark font-weight-bold">
                                            <span class="d-block">
                                                {{type.name}} <br>
                                                <small>{{type.display_price}} <?php echo e(__("per ticket")); ?></small>
                                            </span>
                        ...
                        <div class="form-section-group form-group border-bottom border-width-2 border-color-1 pb-1" v-if="booking_time_slots">
                            <span class="flex-center-between mb-1 font-size-16 text-dark font-weight-bold"><?php echo e(__('Start Time:')); ?></span>
...
<?php echo $__env->make("Booking::frontend.global.enquiry-form",['service_type'=>'event'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/earntbpk/public_html/themes/Mytravel/Event/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>