        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        <?php if(!empty($rows)): ?>
                            <form method="post" action="<?php echo e(route('language.admin.bulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
                    ...
                    <div class="col-left">
                        <form method="get" action="<?php echo e(route('language.admin.index')); ?>" class="filter-form filter-form-right d-flex justify-content-end" role="search">
                                    ...
                                    <?php if(count($rows) > 0): ?>
                                        <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="title">
                                                    <a href="<?php echo e(route('language.admin.edit',['id'=>$row->id])); ?>">
                                                        <?php if($row->flag): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/earntbpk/public_html/modules/Language/Views/admin/language/index.blade.php ENDPATH**/ ?>