    ...
    <div class="col-lg-9 col-md-12">
        <div class="bravo-list-item">
            <div class="d-flex justify-content-between align-items-center mb-4 topbar-search">
                ...
                <div class="control">
                    <?php echo $__env->make('Boat::frontend.layouts.search.orderby', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
            <div class="list-item">
                <div class="row">
...
<?php /**PATH /home/earntbpk/public_html/themes/Mytravel/Boat/Views/frontend/layouts/search/list-item.blade.php ENDPATH**/ ?>