<div class="sidebar border border-color-1 rounded-xs">
    <div class="p-4 mb-1">
        <form action="<?php echo e(route("event.search")); ?>" class="bravo_form" method="get">
            <?php $search_fields = setting_item_array('event_search_fields');
...
</div><?php /**PATH /home/earntbpk/public_html/themes/Mytravel/Event/Views/frontend/layouts/search/form-search-vertical.blade.php ENDPATH**/ ?>