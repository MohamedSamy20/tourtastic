                    ...
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-body">
                                ...
                                <?php echo $__env->make('Location::admin/category/form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/earntbpk/public_html/modules/Location/Views/admin/category/detail.blade.php ENDPATH**/ ?>