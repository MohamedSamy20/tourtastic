<div class="row">
    ...
    <div class="col-lg-9 col-md-12">
        <div class="bravo-list-item">
            ...
            <?php if($rows->total() > 0): ?>
                <div class="text-center text-md-left font-size-14 mb-3 text-lh-1"><?php echo e(__("Showing :from - :to of :total events",["from"=>$rows->firstItem(),"to"=>$rows->lastItem(),"total"=>$rows->total()])); ?></div>
            <?php endif; ?>
...
<?php /**PATH /home/earntbpk/public_html/themes/Mytravel/Event/Views/frontend/layouts/search/list-item.blade.php ENDPATH**/ ?>