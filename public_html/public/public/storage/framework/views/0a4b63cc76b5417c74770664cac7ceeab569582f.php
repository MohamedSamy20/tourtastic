...
<?php if(is_default_lang()): ?>
    ...
    <div class="row">
        <div class="col-sm-4">
            <h3 class="form-group-title"><?php echo e(__('Email From Config')); ?></h3>
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            ...
                            <p><i><?php echo e(__("You will get all notifications from this email")); ?></i></p>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            $(document).on('click', '#email-testing', function (e) {
                ...
                if (testEmail.test(to)) {
                    if (cant_test == 1) {
                        cant_test = 0;
                        $.ajax({
                            url: '<?php echo e(route('email.admin.testEmail')); ?>',
                            type: 'get',
                            data: {to: to},
                            beforeSend: function () {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/earntbpk/public_html/modules/Email/Views/admin/settings/email.blade.php ENDPATH**/ ?>