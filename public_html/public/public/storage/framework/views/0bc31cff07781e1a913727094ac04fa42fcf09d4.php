<div class="bravo-form-search-all hero-block hero-v1 bg-img-hero-bottom gradient-overlay-half-black-gradient text-center z-index-2" style="background-image: url('<?php echo e($bg_image_url); ?>') !important;">
    <div class="container space-2 space-top-xl-4">
        ...
        <?php if(empty($hide_form_search)): ?>
            <div class="mb-lg-n1">
                <ul class="nav tab-nav flex-nowrap tab-nav-boxed pb-4 pt-2 justify-content-xl-center <?php if(!empty($single_form_search)): ?> d-none <?php endif; ?>" role="tablist">
...
<?php /**PATH /home/earntbpk/public_html/themes/Mytravel/Template/Views/frontend/blocks/form-search-all-service/style_2.blade.php ENDPATH**/ ?>