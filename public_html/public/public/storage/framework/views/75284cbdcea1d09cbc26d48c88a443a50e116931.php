                ...
                <div class="panel">
                    <div class="panel-body pd15">
                        <div class="row area-setting-row">
                            ...
                            <?php endif; ?>
                            <?php if($user->hasPermission('plugin_manage')): ?>
                                <?php $hasAvailableTools = true; ?>
                                <div class="col-md-4">
                                    <div class="area-setting-item">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/earntbpk/public_html/modules/Core/Views/admin/tools/index.blade.php ENDPATH**/ ?>