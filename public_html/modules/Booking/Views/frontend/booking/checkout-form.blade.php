<div class="form-checkout" id="form-checkout" >
    ...
    <div class="form-section">
        <div class="row">
            ...
            <div class="col-md-6 field-zip-code d-none">
                <div class="form-group">
            ...
            <div class="col-md-6 field-country d-none">
                <div class="form-group">
                    <label >{{__("Country")}} <span class="required">*</span> </label>
                    <select name="country" class="form-control">
                        <option value="">{{__('-- Select --')}}</option>
                        @foreach(get_country_lists() as $id=>$name)
                            <option @if(($user->country ?? 'SY') == $id) selected @endif value="{{$id}}">{{$name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
