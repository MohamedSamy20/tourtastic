...
class BookingController extends \App\Http\Controllers\Controller
{
    ...
    public function doCheckout(Request $request)
    {
        ...
        $booking->address = $request->input('address_line_1')??'no address';
        $booking->address2 = $request->input('address_line_2')??'no address';
        $booking->city = $request->input('city')??'no city';
        $booking->state = $request->input('state')??'state';
        $booking->zip_code = $request->input('zip_code')??'no zip';
        $booking->country = $request->input('country')??'SY';
