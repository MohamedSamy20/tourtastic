...
Route::group(['prefix'=>config('booking.booking_route_prefix')],function(){
    ...
    Route::match(['get','post'],'/confirm/{gateway}','BookingController@confirmPayment');
    Route::match(['get','post'],'/cancel/{gateway}','BookingController@cancelPayment');
...
Route::group(['prefix'=>'gateway'],function(){
    Route::match(['get','post'],'/confirm/{gateway}','NormalCheckoutController@confirmPayment')->name('gateway.confirm');
    Route::match(['get','post'],'/cancel/{gateway}','NormalCheckoutController@cancelPayment')->name('gateway.cancel');
