...
<div class="profile-service-tabs">
    ...
    <div class="tab-content">
        ...
        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type=>$moduleClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
                <?php if(view()->exists(ucfirst($type).'::frontend.profile.service') && $user->hasPermission($type.'_create')): ?>
...
<?php /**PATH /home/customer/www/tourtastic.net/public_html/themes/Mytravel/User/Views/frontend/profile/services.blade.php ENDPATH**/ ?>