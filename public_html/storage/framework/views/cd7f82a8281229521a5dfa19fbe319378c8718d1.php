<?php
if(!$user->hasPermission('tour_create')) return;
?>
<?php if(!empty($services) and $services->total()): ?>
    <div class="bravo-profile-list-services">
        <?php echo $__env->make('Tour::frontend.blocks.list-tour.style_1', ['rows'=>$services,'desc'=>' ','title'=>!empty($view_all) ? __('Tour by :name',['name'=>$user->first_name]) : '','col'=>4], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="container">
...
<?php endif; ?>
<?php /**PATH /home/customer/www/tourtastic.net/public_html/themes/Mytravel/Tour/Views/frontend/profile/service.blade.php ENDPATH**/ ?>