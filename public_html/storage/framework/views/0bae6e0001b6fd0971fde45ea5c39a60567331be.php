<div class="bravo-form-search-space <?php if(!empty($style) and $style == "carousel"): ?> bravo-form-search-slider <?php endif; ?>" <?php if(empty($style)): ?> style="background-image: linear-gradient(0deg,rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('<?php echo e($bg_image_url); ?>') !important" <?php endif; ?>>
...
</div><?php /**PATH /home/customer/www/tourtastic.net/public_html/themes/Mytravel/Flight/Views/frontend/blocks/form-search-flight/index.blade.php ENDPATH**/ ?>