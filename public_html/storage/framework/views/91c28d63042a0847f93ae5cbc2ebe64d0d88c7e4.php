...
<div id="advance_filters" class="d-none">
    ...
    <div class="ad-filter-f text-right">
        <a href="#" onclick="return false" class="btn btn-primary bn-sm btn-apply-advances"><?php echo e(__("Apply Filters")); ?></a>
    </div>
</div>
<?php /**PATH /home/customer/www/tourtastic.net/public_html/themes/Mytravel/Car/Views/frontend/layouts/search-map/advance-filter.blade.php ENDPATH**/ ?>