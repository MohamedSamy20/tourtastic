...
class SeeruTestController extends Controller
{
     ...
     */
    public function testGetResult(Request $request, $searchId)
    {
        if (empty($searchId)) {
     ...
     */
    public function testCheckFare(Request $request)
    {
...
public function testSaveBooking(Request $request)
{
    ...
    public function testOrderDetails(Request $request)
    {
    ...
    public function testCancelOrder(Request $request)
    {
        $orderId = $request->input('order_id');
        if (!$orderId) {
            return response()->json(['error' => 'Missing order_id'], 400);
    ...
    public function testIssueOrder(Request $request)
    {
        $orderId = $request->input('order_id');
        if (!$orderId) {
            return response()->json(['error' => 'Missing order_id'], 400);
     ...
     */
    public function testTicketDetails(Request $request)
    {
     ...
     */
    public function testTicketRetrieve(Request $request)
    {
     ...
     */
    public function testTicketRefund(Request $request)
    {
        $ticketId = $request->input('ticket_id');
     ...
     */
    public function testTicketVoid(Request $request)
    {
        $ticketId = $request->input('ticket_id');
        $passengers = $request->input('passengers', []);
        if (!$ticketId) {
     ...
     */
    public function testTicketExchange(Request $request)
    {
        $ticketId = $request->input('ticket_id');
